...
BOOTHもまた、ただ作品を紹介し、販売者と購入者で直接やりとりして、商品の取り引きを成立させることを許しています。ただ作品とその価格を掲載するだけ、ということもできるのです。これに購入者が反応し、販売者にコンタクトをとって互いに直接的に作品交換を行うことがあっても、BOOTHは一切そこに関与しないようです。創作系イベントの文化が、うまく扱えるようになっているわけですね。
...
繰り返しますが、BOOTHはクリエーターやアーティストたちが活動する現場が求めていることを実現しようと、様々な機能があたえられています。作品を気軽にみてもらいたい！という用途にも使えるので、創作に関わる人はBOOTHで自分にあった使い方を探ってみるのもいいかもしれません。
